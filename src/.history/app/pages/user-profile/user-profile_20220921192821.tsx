...
const UserProfile: FC = () => {
  ...
  const [filteredUsers, setFilteredUsers] = useState(currentdataList)
  console.log('🚀 ~ file: user-profile.tsx ~ line 253 ~ filteredUsers', filteredUsers)
  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      const filter = _.filter(currentdataList, (user) => {
        ...
        <div className='row'>
          <div className='col-md-5 col-sm-12'>
            <div className='dataTables_info' id='sample_1_info' role='status' aria-live='polite'>
              Showing {indexOfFirstData + 1} to {indexOfLastData - 1} of {data.length} entries
            </div>
          </div>
